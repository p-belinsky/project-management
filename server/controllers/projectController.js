  ...
  try {
    ...
    if (
      ...
      return res
        .status(403)
        .json({
          message: "You are not authorized to create project in this workspace",
        });
    }
  ...
  try {
    ...
    if (!workspace.members.some((member) => member.userId === userId && member.role === "ADMIN")) {
       ...
       if(!project){
        ...
        return res.status(403).json({ message: "You are not authorized to update projects in this workspace" });
       }
    }
